      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-white dark:bg-neutral-900 border-b border-neutral-100 dark:border-neutral-800 shadow-lg"
          >
            <div className="container-wide py-4 flex flex-col gap-1">
              ...
              <div className="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-800 flex flex-col gap-2">
                <a
                  href={createPhoneHref(siteConfig.phone)}
                  className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-neutral-50 dark:bg-neutral-800 text-sm font-semibold text-neutral-700 dark:text-neutral-300"
                >
