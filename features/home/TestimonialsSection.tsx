    ...
    <Section background="light">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative mb-8">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="rounded-3xl bg-white border border-neutral-200/80 shadow-sm p-8 md:p-12"
            >
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 mb-1">
                    <h4 className="font-bold text-neutral-900">{current.name}</h4>
                ...
                <svg
                  className="h-10 w-10 text-brand-100 flex-shrink-0 hidden sm:block"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-neutral-100">
                ...
                <span className="text-sm text-neutral-400">{current.date}</span>
              </div>
            </motion.div>
          </AnimatePresence>
        </div>
        ...
        <div className="flex items-center justify-between">
          <button
            onClick={handlePrev}
            className="flex h-10 w-10 items-center justify-center rounded-full border border-neutral-200 bg-white text-neutral-600 hover:border-brand-600 hover:text-brand-600 transition-colors shadow-sm"
            ...
            {testimonials.map((_, i) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  i === active ? "w-8 bg-brand-600" : "w-2 bg-neutral-300"
                }`}
